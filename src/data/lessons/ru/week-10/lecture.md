...
Чтобы понять, как ИИ взаимодействует с внешним миром, мы должны деконструировать саму концепцию JSON-схем и то, как современные модели (GPT-4o, Claude 3.5 Sonnet) интерпретируют их.
...
[ 1. ASYNCHRONOUS TRIGGER / USER INPUT ]
 ...
 v
+-----------------------------------------------------------------------------------------+
| 2. COGNITIVE ENGINE (Python SDK: OpenAI gpt-4o / Anthropic Claude 3.5) |
...
[ 1. RAW UNSTRUCTURED INPUT ] -> (e.g., 50-page PDF B2B Contract / Invoice)
 ...
 v
+-----------------------------------------------------------------------------------------+
| 2. COGNITIVE EXTRACTION ENGINE (OpenAI gpt-4o / Anthropic Claude 3.5) |
...
[ 1. ASYNCHRONOUS TASK QUEUE ] -> 10,000 Document Processing Jobs
 ...
 v
+-----------------------------------------------------------------------------------------+
| 2. PRIMARY LLM EXECUTION (e.g., Claude 3.5 Sonnet) |
| - `try:` block execution |
+-----------------------------------------------------------------------------------------+
...
def resilient_llm_call(prompt: str, max_retries: int = 5) -> Optional[str]:
 ...
 try:
 logging.info("Routing request to Backup Model (Claude 3.5)...")
...
[ 1. ASYNCHRONOUS TASK QUEUE ] -> Agent dispatches 500 concurrent LLM extraction tasks
 ...
 v
+-----------------------------------------------------------------------------------------+
| 2. PRIMARY EXECUTION LAYER (e.g., Anthropic Claude 3.5 Sonnet) |
